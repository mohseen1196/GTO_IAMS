        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Green Top Organics</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								<li>
                                    <a href="inward_ProductsList.php"><i class="fa fa-tasks fa-fw"></i> Products List</a>
                                </li>
                                <li>
                                    <a href="inward_Purchase.php"><i class="fa fa-shopping-cart fa-fw"></i> Purchase</a>
                                </li>
								 <li>
                                    <a href="inward_Purchase_Bags.php"><i class="fa fa-bitbucket fa-fw"></i> Purchase Bags</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-signal fa-fw"></i><b> Production</b><span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-rupee fa-fw"></i><b> Sales</b><span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i><b> Client Details</b><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
						...
						<li>
                        <a href="#"><i class="glyphicon glyphicon-globe fa-fw"></i><b> Supplier Details</b><span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
									<a href="supplier_add.php"><i class="fa fa-openid fa-fw"></i> Add Supplier</a>
								</li>
								<li>
									<a href="supplier_list.php"><i class="glyphicon glyphicon-stats  fa-fw"></i> Supplier List</a>
								</li>
							</ul>
                        </li>
						<li>
